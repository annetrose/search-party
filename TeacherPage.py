...
#		from django.utils import simplejson as json
	...
	def make_student_structure(self, lesson):
		...
		searches_dict = {}
		for activity in StudentActivity.all().filter("lesson =", lesson).order("timestamp"):
	...
	def make_student_structure_js(self, lesson, indent):
		...
		add("var g_students = {};")
		add('var student_info, task_info, task_infos, search_info, search_infos, followed_link_info, followed_link_infos, answer_info;')
